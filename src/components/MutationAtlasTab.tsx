...
import { CropImage, GrowthPhases, RemoteImage, mutationIconUrls } from './shared';
...
function GoldenDetail({ item, onClose }: { item: GoldenEntry; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div className="relative glass-panel rounded-2xl p-6 max-w-sm w-full max-h-[85vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        ...
        <GrowthPhases seedId={item.seedId} gold={isGold} />
